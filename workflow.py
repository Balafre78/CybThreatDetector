...
from training import train_model, DEFAULT_DECISION_TREE_MODEL_PATH, DEFAULT_RANDOM_FOREST_MODEL_PATH, \
    DEFAULT_LOGISTIC_REGRESSION_MODEL_PATH, DEFAULT_XGBOOST_MODEL_PATH
from analysis import plot_confusion_matrix, plot_feature_importance, plot_multiclass_roc, shap_analysis
from visualization import plot_zero_value_features, plot_benign_vs_attacks, plot_class_distribution
...
class WorkflowManager:
    def __init__(
            ...
            xgboost_model_path: str | Path = DEFAULT_XGBOOST_MODEL_PATH,
        ) -> None:
    ...
    def train_xgboost_model(self):
        self.xgboost_model = train_model(
            df_train=self.train_dataset,
            model_name="xgboost",
    ...
    def test_all_models(self):
        ...
        self.test_logistic_regression_model()
    ...
    def analyse_xgboost(self):
        plot_confusion_matrix(model=self.xgboost_model, df_test=self.test_dataset)
...
def run_cli() -> None:
    ...
    while True:
        actions = {
            ...
            "2": {
                "name": "Visualize raw data",
                "func": manager.visualize,
            ...
            "7": {
                ...
                "func": manager.train_xgboost_model,
                "can_execute": manager.train_dataset is not None
            },
            "8": {
            ...
            "12":{
                ...
                "func": manager.test_xgboost_model,
