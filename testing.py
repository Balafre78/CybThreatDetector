...
def evaluate_model(
    ...
    a summary of the metrics via Classification Report and testing Dataframe
    :param model: A given model, either DecisionTreeClassifier, RandomForestClassifier, LogisticRegression or XGBClassifier
